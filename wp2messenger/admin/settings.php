...
if (isset($_GET['success']) && $_GET['success'] == 'true') {
    echo '<div class="notice notice-success is-dismissible"><p>' . __('Configuration saved and form created successfully!', 'wp2messenger') . '</p></div>';
}
?>
<div class="wp2messenger wrap">
    <h1><?php _e('wp2messenger Settings', 'wp2messenger'); ?></h1>
    <form method="post" action="options.php">
        ...
        <table class="wp2messenger form-table">
            <tr valign="top">
                <th scope="row"><?php _e('Eitaa API Token', 'wp2messenger'); ?></th>
                <td><input type="text" name="token_eitaa_api" value="<?php echo esc_attr($token); ?>" readonly /></td>
            </tr>
            <tr valign="top">
                <th scope="row"><?php _e('Eitaa Channel ID', 'wp2messenger'); ?></th>
